...
unsigned tp_aarch64_feature_words(void) { return TARGET_FEATURE_WORDS; }
unsigned tp_aarch64_nfeatures(void) { return num_features; }
unsigned tp_aarch64_ncpus(void) { return num_cpus; }
